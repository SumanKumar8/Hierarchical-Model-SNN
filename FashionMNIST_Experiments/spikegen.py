...
train_data = datasets.FashionMNIST(os.getcwd(), train=True, download=True, transform=transform)
test_data = datasets.FashionMNIST(os.getcwd(), train=False, download=True, transform=transform)
...
train_spk_path = "SpikeGenData_train_Fashion_mnist/"
test_spk_path = "SpikeGenData_test_Fashion_mnist/"
train_target_path = "target_train_Fashion_mnist/"
test_target_path = "target_test_Fashion_mnist/"
